...
export default function Carousel({ isLogin }) {
  ...
  return (
    <div className="relative w-full">
      ...
      >
        {data.map((item, idx) => (
          <SwiperSlide key={idx} className="relative" onDoubleClick={() => onEditCarousel(item)}>
            ...
            <div className="absolute inset-0 flex justify-center items-center z-10">
              <div className="container mx-auto px-3 text-center">
                <div className="w-full text-banner">
                  ...
                  <h2 className="text-6xl mb-10 uppercase font-bold bg-gradient-to-r from-[#07798b] to-[#00c4cc] text-transparent bg-clip-text animate-fade-in">
                    {item.text2}
                  </h2>
